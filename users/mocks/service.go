...
// DisableUser provides a mock function with given fields: ctx, token, id
func (_m *Service) DisableUser(ctx context.Context, token string, id string) (users.User, error) {
	ret := _m.Called(ctx, token, id)
...
// EnableUser provides a mock function with given fields: ctx, token, id
func (_m *Service) EnableUser(ctx context.Context, token string, id string) (users.User, error) {
	ret := _m.Called(ctx, token, id)
...
func (_m *Service) OAuthCallback(ctx context.Context, user users.User) (*magistrala.Token, error) {
	...
	var r0 *magistrala.Token
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, users.User) (*magistrala.Token, error)); ok {
		return rf(ctx, user)
	}
	if rf, ok := ret.Get(0).(func(context.Context, users.User) *magistrala.Token); ok {
		r0 = rf(ctx, user)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*magistrala.Token)
...
// RegisterUser provides a mock function with given fields: ctx, token, user
func (_m *Service) RegisterUser(ctx context.Context, token string, user users.User) (users.User, error) {
...
// UpdateUserRole provides a mock function with given fields: ctx, token, user
func (_m *Service) UpdateUserRole(ctx context.Context, token string, user users.User) (users.User, error) {
	ret := _m.Called(ctx, token, user)
...
// UpdateUserSecret provides a mock function with given fields: ctx, token, oldSecret, newSecret
func (_m *Service) UpdateUserSecret(ctx context.Context, token string, oldSecret string, newSecret string) (users.User, error) {
...
// UpdateUserTags provides a mock function with given fields: ctx, token, user
func (_m *Service) UpdateUserTags(ctx context.Context, token string, user users.User) (users.User, error) {
	ret := _m.Called(ctx, token, user)
...
func (_m *Service) ViewProfile(ctx context.Context, token string) (users.User, error) {
...
// ViewUser provides a mock function with given fields: ctx, token, id
func (_m *Service) ViewUser(ctx context.Context, token string, id string) (users.User, error) {
	ret := _m.Called(ctx, token, id)
